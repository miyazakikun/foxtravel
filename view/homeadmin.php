            ...
            <div class="panel panel-primary">
              ...
              <div class="panel-body">
                <div class="list-group">
                  <a class="list-group-item" href="view/admininputpesawat.php">Tambah Data Pesawat<br></a>
                  <a class="list-group-item" href="halaman_depan.php?halaman=tidakaktif">Lihat History Pesawat<br></a>
                  <a class="list-group-item" href="halaman_depan.php?halaman=pembelian">Lihat List Pembelian<br></a>
                  <a class="list-group-item" href="halaman_depan.php?halaman=historypembelian">Lihat History Pembelian<br></a>
                </div>
              ...
              <div class="panel-body">
                ...
                <table class="table">
                  ...
                  <tbody>
                    <?php
                      $no=1;
                      $tampil = $mysqli->query("SELECT * FROM pesawat") or die($mysqli->error);
                    ?>
